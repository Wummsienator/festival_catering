...
lb1 = Label(page1, text="I'm page 1!", font=style1)
lb1.pack(pady=20)

lb2 = Label(page2, text="I'm page 2!", font=style1)
lb2.pack(pady=30)

lb3 = Label(page3, text="I'm page 3!", font=style1)
lb3.pack(pady=50)
