...
\begin{itemize}
    ...
    \item Zuordnung einer Benutzerrolle (Besucher, VIP, Standpersonal)
    ...
    \item QR-Code wird pro Ticket lokal aus zugrunde liegenden Daten aus dem Model generiert
\end{itemize}
...
\begin{itemize}
    ...
    \item VIP-Besucher können über einen Schalter die Bestellung als priorisiert markieren
...
\begin{itemize}
    \item Der generierte QR-Code wird innerhalb der Besucher-Sicht angezeigt
