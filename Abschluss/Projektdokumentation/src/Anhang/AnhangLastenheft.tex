...
\begin{itemize}
    ...
    \item Unterscheidung von Benutzerrollen (Besucher*innen, \acs{VIP}-Besucher*innen, Standpersonal)
    \item Generierung eines eindeutigen \acs{QR}-Codes pro Besucher-Ticket
\end{itemize}
...
\begin{itemize}
    ...
    \item Hinzufügen von Sonderwünschen pro Bestellung
    \item Priorisierung von Bestellungen für \acs{VIP}-Besucher*innen
...
\begin{itemize}
    ...
    \item Änderung des Bestellstatus (Bestellung aufgegeben, In Bearbeitung, Bereit zur Abholung, Ausgegeben)
\end{itemize}

\subsubsection*{Abholprozess}
\begin{itemize}
    \item Anzeige des \acs{QR}-Codes zur Abholung
