...
zur Verfügung stehen, das für Bestellungen genutzt werden kann. Außerdem soll dem Benutzer bzw. der Benutzerin ein \acs{QR}-Code zur Verfügung gestellt werden,
...
Zusätzlich soll das System eine bevorzugte Behandlung von \acs{VIP}-Besucher*innen ermöglichen.
