...
entwickelt und basiert auf der Programmiersprache Python. Python wurde gewählt, da im schulichen Unterricht größtenteils diese Sprache verwendet
...
Zugriff auf relationale Datenbanken über eine standardisierte Schnittstelle (\acs{ODBC}) und unterstützt die Ausführung von SQL-Abfragen direkt
...
edienung für alle Benutzergruppen zu gewährleisten.
...
Beide Darstellungen sind im Anhang unter \bhref{app:ER-Diagramm} und \bhref{app:Relationales_Datenbankmodell} einsehbar.
